<template><div><h1 id="c语言判断与循环" tabindex="-1"><a class="header-anchor" href="#c语言判断与循环"><span>C语言判断与循环</span></a></h1>
<p>判断语句<br>
...
嵌套 switch 语句 可以在一个 switch 语句内使用另一个 switch 语句。</p>
<p><strong>if else 语句</strong></p>
<p>if(boolean_expression)<br>
{<br>
/ <em>如果布尔表达式为真将执行的语句</em> /<br>
}<br>
else<br>
{<br>
/ <em>如果布尔表达式为假将执行的语句</em> /<br>
}</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中if 中语句是条件，age要大于等于18，后面英语分数和IQ满足一项就可以执行 &quot;成年! 允许玩&quot;，否则执行else 后的语句。</p>
<p>if 可以嵌套使用，但不建议又过多的if</p>
<div class="language-html line-numbers-mode" data-highlighter="shiki" data-ext="html" data-title="html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">include &#x3C;</span><span style="--shiki-light:white;--shiki-dark:#E06C75">stdio.h</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  return 0;</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>switch语句可以嵌套使用</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>#include &#x3C;stdio.h></span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>for 循环是一种在编程中经常使用的迭代结构，用于重复执行一组语句，直到指定的条件不再满足。for 循环的基本语法如下：</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1.初始化表达式 (init)：在循环开始之前执行一次。通常用于初始化循环控制变量。这一部分可以包含声明和赋值操作。</p>
<p>2.循环条件 (condition)：在每次循环迭代之前检查的条件。如果条件为真（true），循环将继续执行；如果条件为假（false），循环将终止。</p>
<p>3.迭代表达式 (increment)：在每次循环迭代之后执行。通常用于更新循环控制变量的值。</p>
<p>4.循环体语句 (statement(s))：在每次循环迭代时执行的一组语句。这是循环的主体，包含了实际的操作。</p>
<p><strong>我会举个简单的例子，利用for循环计算1到5的和</strong></p>
<div class="language-html line-numbers-mode" data-highlighter="shiki" data-ext="html" data-title="html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">#include &#x3C;</span><span style="--shiki-light:white;--shiki-dark:#E06C75">stdio.h</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">int main() </span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">{</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    return 0;</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1.首先就是初始化表达式 int i = 1; 在循环开始前初始化循环控制变量 i，i就是1。<br>
2.循环条件 i &lt;= 5 在每次循环迭代前检查 i 是否小于等于 5。<br>
3.迭代表达式 i++ 在每次循环迭代后将 i 的值增加 1。<br>
4.循环体语句 sum += i; 在每次循环迭代时将当前的 i 加到 sum 中。</p>
<p><strong>sum += i就是 sum = sum + i</strong><br>
循环开始时，sum 的初始值为 0，然后在每次循环中，当前的 i 的值都会加到 sum 上，最终得到 1 到 5 的和。<br>
第一次循环：sum = 0 + 1，sum 的值为 1。<br>
第二次循环：sum = 1 + 2，sum 的值为 3。<br>
第三次循环：sum = 3 + 3，sum 的值为 6。<br>
第四次循环：sum = 6 + 4，sum 的值为 10。<br>
第五次循环：sum = 10 + 5，sum 的值为 15。</p>
<p>i++（后缀递增）：<br>
先使用当前值，然后再递增。<br>
返回 i 的原始值，然后将 i 增加 1。</p>
<p>int i = 5;<br>
int result = i++;<br>
// result = 5, i = 6</p>
<p>++i（前缀递增）：</p>
<p>先递增，然后再使用新值。<br>
返回 i 增加 1 后的值。</p>
<p><strong>在C语言中，for 循环的循环体可以是一个单独的语句，也就是说，你可以在没有大括号的情况下编写 for 循环。如果 for 循环只有一条语句，大括号是可选的</strong> 。<br>
<strong>在你的代码中，你的 for 循环只有一条语句，因此去掉大括号是合法的。以下是你的代码的修正版：</strong></p>
<div class="language-html line-numbers-mode" data-highlighter="shiki" data-ext="html" data-title="html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">#include &#x3C;</span><span style="--shiki-light:white;--shiki-dark:#E06C75">stdio.h</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">int main() </span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">{</span></span>
...
<p><img src="https://blog.200310.xyz/usr/uploads/2024/02/1163191085.png" alt="屏幕截图 2024-02-20 233732.png" title="屏幕截图 2024-02-20 233732.png"></p>
<p><strong>求1到100中所有偶数的和</strong></p>
<div class="language-html line-numbers-mode" data-highlighter="shiki" data-ext="html" data-title="html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">#include &#x3C;</span><span style="--shiki-light:white;--shiki-dark:#E06C75">stdio.h</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">int main() {</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    return 0;</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://blog.200310.xyz/usr/uploads/2024/02/2460638926.png" alt="屏幕截图 2024-02-20 234256.png" title="屏幕截图 2024-02-20 234256.png"></p>
<p>在上述的C程序中，初始时 even_sum 被初始化为0，而 num 被设置为0。在第一次循环迭代中，num 的值是0，因此 even_sum 将增加0，即 even_sum 的值仍然是0（even_sum = even_sum + num）。所以，第一次循环迭代后，even_sum 的值仍然是0。第二次循环结果是2.</p>
<p>在第二次循环迭代中，num 的值已经被自增为2。循环条件 num &lt;= 100 仍然满足，因此循环继续执行。在第二次迭代中，even_sum += num; 将 even_sum 加上 num（此时 num 的值为2），并且 num += 2; 将 num 自增为4。所以，第二次循环迭代后，even_sum 的值是2，而 num 的值变为4。</p>
<p>这个过程会一直重复，每次迭代都会将 num 的当前值加到 even_sum 中，然后将 num 增加2。最终，当 num 的值超过100时，循环终止。在循环结束时，even_sum 包含了0到100之间所有偶数的总和。</p>
<p>第一步执行rush = 1;就是初始化表达式，第二步执行循环条件，看rush 是否小于1000 ，第三步执行循环体语句，rush = 1. 第四步执行自加语句rush ++，此时rush 是2。 第五步执行循环条件，rush &lt;= GOLD;即rush &lt;= 1000，第六步执行自增语句，rush变成了3，第七步执行循环体语句，输出 rush = 7;</p>
<p><strong>以下是一个简单的C语言程序，用于生成斐波那契数列的前n个数字：</strong></p>
<div class="language-html line-numbers-mode" data-highlighter="shiki" data-ext="html" data-title="html" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">#include &#x3C;</span><span style="--shiki-light:white;--shiki-dark:#E06C75">stdio.h</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    return 0;</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>外层循环 (for (row = 1; row &lt;= 9; row++)): 控制行数，从1到9。</strong></p>
<p><strong>内层循环 (for (column = 1; column &lt;= 9; column++)): 控制每行中的列数，同样从1到9</strong> 。</p>
<p>在内层循环中，printf语句输出了每一项的乘法表达式，其中%d*%d = %2d\t 是格式控制字符串，它表示输出两个整数相乘的结果，其中 %d 是用来格式化整数的占位符，%2d 表示至少输出两个字符的整数，\t 是制表符（用于在输出中产生水平制表）。</p>
<p>代码里printf(&quot;%d*%d = %2d\t&quot;, row, column, row* column); 语句用于输出九九乘法表中每一项的表达式。这样的格式化输出有助于让输出结果整齐对齐，提高可读性。例如，如果乘积是个位数，%2d 会在前面补一个空格，确保每一项的输出都占用两个字符的宽度。\t 是制表符（用于在输出中产生水平制表）。</p>
<p>调试：<br>
<img src="https://blog.200310.xyz/usr/uploads/2024/02/3871918122.png" alt="屏幕截图 2024-02-20 234525.png" title="屏幕截图 2024-02-20 234525.png"></p>
</div></template>
